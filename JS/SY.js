    ...
    if (syData.Subjects && syData.Semester1 && syData.Semester2) {
      syData.Subjects.forEach((subject, index) => {
        ...
        row.innerHTML = `
          ...
          <td><input type="text" id="s1g" value="${syData.Semester1[index]}" class="w-full px-4 py-2 inputBG focus:outline-none focus:bg-gray-700 transition duration-200"></td>
          <td><input type="text" id="s2g" value="${syData.Semester2[index]}" class="w-full px-4 py-2 inputBG focus:outline-none focus:bg-gray-700 transition duration-200"></td>
        `;

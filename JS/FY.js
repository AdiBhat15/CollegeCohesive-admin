    ...
    if (fyData.Subjects && fyData.Semester1 && fyData.Semester2) {
      fyData.Subjects.forEach((subject, index) => {
        ...
        row.innerHTML = `
          ...
          <td><input type="text" id="s1g" value="${fyData.Semester1[index]}" class="w-full px-4 py-2 inputBG focus:outline-none focus:bg-gray-700 transition duration-200"></td>
          <td><input type="text" id="s2g" value="${fyData.Semester2[index]}" class="w-full px-4 py-2 inputBG focus:outline-none focus:bg-gray-700 transition duration-200"></td>
        `;
